...
public class DateUtil extends DateUtils {
    ...
    private static final String[] FORMATS = {"yyyy-MM-dd","yyyyMMddHHmmss","yyMMddHHmmss","yyMMddHHmm", "yyyy-MM-dd HH:mm",
...
//        calendar.setTime(date);
        ...
        System.out.println(DateUtil.convert(new Date(),"yyyyMMddHHmmssS"));
        System.out.println(DateUtil.convert(new Date(),"yyMM"));
